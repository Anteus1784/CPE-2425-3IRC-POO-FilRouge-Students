...
public class TestAtelier2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("cardRender.equals(c2) : " + cardRender.equals(c2)); // true
		System.out.println("cardRender.hashCode() : " + cardRender.hashCode()); // same as c2.hashCode()
		...
		System.out.println("playerRender.getName() : " + playerRender.getName()); // Joueur1
		System.out.println("playerRender.isStillActive() : " + playerRender.isStillActive()); // true
		System.out.println("playerRender.isTrickWinner() : " + playerRender.isTrickWinner()); // false
		System.out.println("playerRender.isGameWinner() : " + playerRender.isGameWinner()); // false
		System.out.println("playerRender.equals(p1) : " + playerRender.equals(p1)); // true
		System.out.println("playerRender.hashCode() : " + playerRender.hashCode()); // same as p1.hashCode()
		System.out.println("playerRender.toString() : " + playerRender.toString());
